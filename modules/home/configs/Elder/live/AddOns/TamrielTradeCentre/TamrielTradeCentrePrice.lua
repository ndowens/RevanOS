...
function TamrielTradeCentrePrice:GetPriceInfo(itemInfoOrLink)
	...
	return TamrielTradeCentre_PriceInfo:New(priceDict.Avg, priceDict.Max, priceDict.Min, priceDict.EntryCount, priceDict.AmountCount, priceDict.SuggestedPrice, priceDict.SaleAvg, priceDict.SaleEntryCount, priceDict.SaleAmountCount)
end
