...
local PAJStrings = {
    ...
    SI_PA_MENU_JUNK_AUTOMARK_INTRICATE = table.concat({"Markiere %s mit Eigenschaft [", GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_ARMOR_INTRICATE), "]"}),
    SI_PA_MENU_JUNK_AUTOMARK_INTRICATE_T = table.concat({"Automatisch %s mit der Eigenschaft [", GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_ARMOR_INTRICATE), "] (erhöhter Verkaufspreis) als Trödel markieren?"}),
