...
local PACOStrings = {
    ...
    SI_PA_CHAT_CONSUME_TO_ENABLE_EXPING = "To enable EXP buff consuming for this character open inventory, right click on the food or drink you want, and choose the Consume Automatically option.",
