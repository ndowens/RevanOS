...
local opTable = {
	...
	[14] = tostring(13)..": "..L.CompanionXP,
	[15] = tostring(14)..": "..L.CompanionRapport,
	[16] = tostring(15)..": "..L.SkillDisplay,
	[17] = tostring(16)..": "..L.Achievements,
	[18] = tostring(17)..": "..L.Everything,
}
...
--	[17] = tostring(16)..": "..L.Everything,
	...
	-- initialize different preview modes per-update and separate functions so multiple can be fired each pass
		...
		elseif (previewMode == 13) then -- preview fragments
			Pop_Fragments()
		elseif (previewMode == 14) then -- preview companion xp
			Pop_CompXP()
		elseif (previewMode == 15) then -- preview rapport
			Pop_Rapport()
		elseif (previewMode == 16) then -- preview skills
			Pop_Skills()
		elseif (previewMode == 17) then -- preview achievements
			Pop_Achievements()
		elseif (previewMode == 18) then -- preview everything
			...
			elseif (popType == 13) then -- preview endless
				Pop_Fragments()
			elseif (popType == 14) then -- preview companion xp
				Pop_CompXP()
			elseif (popType == 15) then -- preview rapport
				Pop_Rapport()
			elseif (popType == 16) then -- preview skills
				Pop_Skills()
			elseif (popType == 17) then -- preview achievements
				Pop_Achievements()
			end
		else
			previewMode = 1
